// -*-c++-*-
#ifndef _PHYLLOPTIM_H_
#define _PHYLLOPTIM_H_

// ============================================================================
// THIS IS THE R-FACING UMBRELLA HEADER, AND IT PULLS IN Rcpp.
//
// If you are embedding the model in C++ -- which is what `LinkingTo: phylloptim`
// means, and what plant does -- you want <phylloptim.hpp>, not this file. That one is
...
// hardwires both `#include <phylloptim.h>` in the code it generates and
